...
inmuebles= [];
  ...
  constructor(public navCtrl: NavController,
    public http: HttpClient) {
      ...
      .subscribe(data => {
        console.log(JSON.stringify(data['ads'],null,3));
...
//PRECIO DEL INMUEBLE ESTA EN ADS, DESPUES EN PRICE, Y FORMATTEDAMOUNT. LA UBICACION ESTA EN GEO, Y EN ATRIBUTO NAME. LA IMAGEN ESTA EN EL ARREGLO PICTURES EN LA POSICIÓN 0 
